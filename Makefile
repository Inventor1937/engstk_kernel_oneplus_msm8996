...
ARCH		?= arm64
CROSS_COMPILE	?= $(CCACHE) /home/ivankolev/citrus/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-7.x/bin/aarch64-linux-android-
...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -O3 -fomit-frame-pointer -fgcse-las -fgraphite -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block -pipe -Wno-unused-parameter -Wno-sign-compare -Wno-missing-field-initializers -Wno-unused-variable -Wno-unused-value -w
...
EXTRA_OPTS	= -fmodulo-sched -fmodulo-sched-allow-regmoves -g0 -ftree-loop-vectorize -ftree-loop-distribute-patterns -ftree-slp-vectorize -fvect-cost-model -ftree-partial-pre -fgcse-after-reload -fgcse-lm -fgcse-sm -fsched-spec-load -ffast-math -fsingle-precision-constant -fpredictive-commoning
CORTEX_OPTS	= -mcpu=cortex-a57+crc+crypto
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration \
                   -Wno-format-security -fmodulo-sched -Wno-bool-compare -Wno-memset-transposed-args -Wno-unused-const-variable \
                   -Wno-misleading-indentation -Wno-tautological-compare -fgcse-after-reload -fno-delete-null-pointer-checks -ftree-loop-vectorize \
